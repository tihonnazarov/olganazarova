...
class Calculator extends Component {
    ...
    render() {
        ...
        return (
            <div className="cll grid place-items-center font text-white">
                <h2 className="text-2xl font-semibold mb-6">Предварительный расчёт стоимости изготовления</h2>
                <div>
                    ...
                    <div className="container mx-auto">
                        <div className="flex justify-between items-center">
                            <div className="flex flex-nowrap gap-2">
                                ...
                                <h2>+7 (903) 675-08-61</h2>
                            </div>
                            <div className="flex flex-nowrap gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-black w-6 h-6">
                                    <path strokeLinecap="round" d="M16.5 12a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zm0 0c0 1.657 1.007 3 2.25 3S21 13.657 21 12a9 9 0 10-2.636 6.364M16.5 12V8.25" />
                                </svg>
                                <h2>marbella80@mail.ru</h2>
                            </div>
                            <div className="flex flex-nowrap gap-2">
